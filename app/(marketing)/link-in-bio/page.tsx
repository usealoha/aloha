        ...
        <div className="relative max-w-[1320px] w-full mx-auto px-6 lg:px-10 pt-20 lg:pt-28 pb-24 lg:pb-32 grid grid-cols-12 gap-x-0 gap-y-8 lg:gap-12 items-center">
          <div className="col-span-12 lg:col-span-7">
            ...
            <h1 className="font-display font-normal text-ink leading-[0.95] tracking-[-0.03em] text-[56px] sm:text-[72px] lg:text-[92px]">
              A page that
              <br />
              <span className="italic text-primary font-light">feels like</span>
              <br />
              the rest of your work.
            </h1>

            <p className="mt-8 max-w-[520px] text-[17px] lg:text-[18px] leading-[1.55] text-ink/70">
              Most link-in-bio tools force you into a template that looks
              like everyone else's. Aloha hands you a warm, editable page
              that matches your voice — fonts, spacing, photography, the
              feel of it — and collects real leads while it's at it.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
              ...
              <a href="#design" className="pencil-link inline-flex items-center gap-2 text-[15px] font-medium text-ink">
          ...
          <div className="col-span-12 lg:col-span-5 relative flex justify-center">
            <div className="absolute top-0 -left-6 z-20 rotate-[-6deg] pointer-events-none">
              <div className="inline-flex items-center gap-2 bg-ink text-peach-200 px-3 py-1.5 rounded-full shadow-[0_6px_16px_-6px_rgba(23,20,18,0.5)]">
                ...
                <span className="font-display text-[12px]">aloha.social/u/you</span>
              </div>
            </div>
            ...
            <div className="relative animate-[float-soft_9s_ease-in-out_infinite]">
              ...
              <div className="relative w-[280px] h-[560px] rounded-[44px] bg-ink p-2 shadow-[0_40px_80px_-30px_rgba(23,20,18,0.4)]">
                ...
                <div className="w-full h-full rounded-[36px] bg-peach-100 overflow-hidden relative">
                  {/* grain */}
                  <svg aria-hidden viewBox="0 0 200 400" className="absolute inset-0 w-full h-full opacity-[0.12] mix-blend-multiply">
                  ...
                  <div className="absolute inset-0 pt-14 px-6 overflow-hidden">
                    ...
                    <div className="flex flex-col items-center">
                      <div className="w-20 h-20 rounded-full bg-peach-300 border-2 border-ink/20 flex items-center justify-center">
                        <span className="font-display italic text-[28px] text-ink">A</span>
                      </div>
                      ...
                      <p className="mt-4 text-center text-[12px] text-ink/75 leading-[1.5] max-w-[220px]">
                      ...
                      {[
                        ...
                        <div
                          ...
                          className={`px-4 py-3 rounded-2xl text-[12.5px] font-medium text-ink border ${
                            i === 0 ? "bg-ink text-peach-200 border-ink" : "bg-background-elev border-border-strong"
                  ...
                  {/* soft bottom fade */}
                  <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-peach-100 to-transparent" />
                </div>
              </div>
              ...
              <div className="hidden sm:flex absolute -bottom-4 -right-8 lg:-right-14 items-center gap-2.5 bg-background-elev text-ink border border-border-strong rounded-full pl-3 pr-4 py-2 shadow-[0_14px_30px_-16px_rgba(23,20,18,0.35)] rotate-[4deg]">
                ...
                <span className="text-[11px] text-ink/50 font-mono">· this week</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-10 grid grid-cols-12 gap-x-0 gap-y-10 lg:gap-16 items-center">
          <div className="col-span-12 lg:col-span-6">
            ...
            <h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
              Not a template.
              <br />
              <span className="italic text-primary">A room.</span>
            </h2>
            <p className="mt-6 text-[16px] lg:text-[17px] text-ink/75 leading-[1.6] max-w-lg">
              ...
              link-cap shapes, headline weight, spacing. It's yours; we
              don't brand-stamp the footer.
            </p>
          ...
          <div className="grid grid-cols-12 gap-x-0 gap-y-10 lg:gap-10 mb-14">
            <div className="col-span-12 lg:col-span-6">
              ...
              <h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
                Turn the visit
                <br />
                <span className="italic text-primary">into a relationship.</span>
              </h2>
            </div>
            <p className="col-span-12 lg:col-span-5 lg:col-start-8 text-[16px] text-ink/70 leading-[1.6] self-end">
              Every Aloha page can collect emails natively — no Mailchimp
              embed, no janky redirect. Tags apply automatically from the
              link that sourced them, so you know who came in from your
              newsletter vs. your portfolio.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={c.h} className={`p-8 rounded-3xl ${c.tone}`}>
                <p className="font-display text-[22px] leading-[1.2] tracking-[-0.01em]">{c.h}</p>
                <p className="mt-3 text-[14px] text-ink/75 leading-[1.55]">{c.p}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-10 grid grid-cols-12 gap-x-0 gap-y-10 lg:gap-16 items-center">
          ...
          <div className="col-span-12 lg:col-span-6 order-1 lg:order-2">
            ...
            <h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
              Which link
              <br />
              <span className="italic text-primary">earns its spot?</span>
            </h2>
            <p className="mt-6 text-[16px] lg:text-[17px] text-ink/75 leading-[1.6] max-w-lg">
              Each link shows you its clicks, its sources, and its
              conversion to subscribe. Reorder based on the data, retire
              links that stopped pulling weight, and stop relying on
              "where did that traffic come from" guesses.
            </p>
        ...
        <div className="max-w-[1100px] mx-auto px-6 lg:px-10">
          <figure className="relative bg-peach-300 rounded-3xl p-10 lg:p-14">
            ...
            <blockquote className="font-display text-[26px] lg:text-[34px] leading-[1.2] tracking-[-0.015em] max-w-3xl">
              "The link page finally stopped looking like everyone else's.
              I got a compliment on it. Like, unsolicited, in a DM. That
              doesn't happen with Linktree."
            </blockquote>
          ...
          <div className="grid grid-cols-12 gap-x-0 gap-y-10 lg:gap-10 items-end">
            <div className="col-span-12 lg:col-span-8">
              <h2 className="font-display text-[44px] sm:text-[56px] lg:text-[80px] leading-[0.98] tracking-[-0.025em]">
                One link.
                <br />
                <span className="italic text-primary">All of you.</span>
              </h2>
            </div>
