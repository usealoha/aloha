...
function PhoneFrame({
	...
	return (
		<div
			className={`relative w-[260px] h-[520px] rounded-[40px] bg-ink p-2 shadow-[0_40px_80px_-30px_rgba(23,20,18,0.4)] ${rotate} ${z}`}
		>
			<div className="absolute top-5 left-1/2 -translate-x-1/2 w-20 h-5 rounded-full bg-ink z-10" />
			<div
				className={`w-full h-full rounded-[32px] ${tone} overflow-hidden relative`}
			>
				<svg
					aria-hidden
					viewBox="0 0 200 400"
					className="absolute inset-0 w-full h-full opacity-[0.1] mix-blend-multiply"
				>
					...
					<rect
						width="100%"
						height="100%"
						filter={`url(#phone-grain-${rotate}-${tone})`}
					/>
				</svg>
				{children}
			</div>
				...
				<div className="relative max-w-[1320px] mx-auto px-6 lg:px-10 pt-20 lg:pt-28 pb-32 lg:pb-40">
					...
					<div className="max-w-3xl mx-auto text-center">
						...
						<p className="mt-8 text-[17px] lg:text-[18px] leading-[1.55] text-ink/70 max-w-xl mx-auto">
							Catch a draft on the walk, approve a send from the couch, reply
							from the line at coffee. Same calm interface, now portable. No
							neon badge farming, no ragebait feed.
						</p>
									...
									<div className="space-y-2.5">
										{[
											...
											},
											{
												...
												c: "X",
												t: "23m",
												color: "bg-background-elev",
											},
										].map((t) => (
											<div
												key={t.n}
												className="p-3 rounded-xl bg-background-elev border border-border flex items-start gap-2.5"
											>
												<span
													className={`w-7 h-7 rounded-full ${t.color} flex items-center justify-center text-[11px] font-display text-ink shrink-0`}
												>
													{t.n[0]}
												</span>
												<div className="min-w-0 flex-1">
													<div className="flex items-center gap-1.5 mb-0.5">
														...
														<span className="text-[9px] font-mono text-ink/45">
															· {t.c}
														</span>
														<span className="ml-auto text-[9px] font-mono text-ink/45">
															{t.t}
														</span>
													</div>
					...
					<div className="max-w-[1320px] mx-auto px-6 lg:px-10">
						<div className="grid grid-cols-12 gap-x-0 gap-y-10 lg:gap-10 mb-14 items-end">
							...
							<p className="col-span-12 lg:col-span-4 text-[15.5px] text-ink/70 leading-[1.55]">
								...
								"quick-post" tab. Everything you do at the desk, you can do from
								the couch.
							</p>
						</div>
					...
					<div className="max-w-[1100px] mx-auto px-6 lg:px-10">
						<figure className="relative rounded-3xl p-10 lg:p-14">
							...
							<blockquote className="font-display text-[26px] lg:text-[34px] leading-[1.2] tracking-[-0.015em] max-w-3xl">
								"I stopped keeping a laptop open on weekends. That sounds small.
								It isn't."
							</blockquote>
				...
				<div className="max-w-[1320px] mx-auto px-6 lg:px-10 py-24 lg:py-32 pb-32 lg:pb-40">
					<div className="max-w-3xl mx-auto text-center">
						<h2 className="font-display text-[44px] sm:text-[56px] lg:text-[80px] leading-[0.98] tracking-[-0.025em]">
							Aloha,
							<br />
							<span className="text-peach-300">wherever you are.</span>
						</h2>
