...
type Props = {
  eyebrow: string;
  headline: ReactNode; // usually two lines with an italic second line
  lead: string;
        ...
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10 grid grid-cols-12 gap-10 lg:gap-16 items-start">
          <div className="col-span-12 lg:col-span-5">
            ...
            <h2 className="font-display text-[30px] lg:text-[40px] leading-[1.05] tracking-[-0.015em]">
              Opinions,
              <br />
              <span className="italic text-primary">not magic.</span>
            </h2>
            <p className="mt-5 text-[14.5px] text-ink/70 leading-[1.6] max-w-md">
              This tool runs entirely in your browser. Nothing goes to a
              server; nothing is logged. We keep it simple so you can
              see exactly what it's doing.
            </p>
          </div>

          <ol className="col-span-12 lg:col-span-7 space-y-4 text-[15px] leading-[1.7] text-ink/85">
            {howItWorks.map((h, i) => (
