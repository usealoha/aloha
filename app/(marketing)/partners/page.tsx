          ...
          <div className="grid grid-cols-12 gap-8 lg:gap-12 items-end">
            <div className="col-span-12 lg:col-span-8">
              ...
              <h1 className="font-display font-normal text-ink leading-[0.95] tracking-[-0.03em] text-[56px] sm:text-[72px] lg:text-[92px]">
                Three ways
                <br />
                <span className="italic text-primary font-light">to build with us.</span>
              </h1>
              <p className="mt-8 max-w-2xl text-[17px] lg:text-[18px] leading-[1.6] text-ink/75">
                Agencies running Aloha for multiple clients. Tools that
                fit into the Aloha surface. Consultants who implement for
                customers. Three tiers, each with named-point-of-contact
                support — not a web form into the void.
              </p>
            </div>
            <div className="col-span-12 lg:col-span-4">
              <a
                href="#apply"
                className="inline-flex items-center gap-2 h-14 px-7 rounded-full bg-ink text-background text-[15px] font-medium hover:bg-primary transition-colors"
              >
        ...
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10">
          <div className="mb-14">
            ...
            <h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
              Pick the shape
              <br />
              <span className="italic text-primary">of your work.</span>
            </h2>
          </div>
                ...
                <ul className="mt-6 space-y-2.5 text-[13.5px] text-ink/85 flex-1">
                  {t.perks.map((p) => (
                    <li key={p} className="flex items-start gap-2.5">
                      <Check className="w-3.5 h-3.5 mt-[3px] text-primary shrink-0" strokeWidth={2.5} />
                      {p}
                    </li>
                  ))}
                </ul>
          ...
          <div className="grid grid-cols-12 gap-10 mb-12 items-end">
            <div className="col-span-12 lg:col-span-7">
              ...
              <h2 className="font-display text-[36px] lg:text-[48px] leading-[1.02] tracking-[-0.02em]">
                People and tools
                <br />
                <span className="italic text-primary">already in the ring.</span>
              </h2>
            </div>
            <p className="col-span-12 lg:col-span-5 text-[15.5px] text-ink/70 leading-[1.55]">
              The current directory — agencies, integrations, and
              solution consultants we've vetted. Filter coming soon; for
              now it's a short scroll.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
            {DIRECTORY.map((d) => (
              ...
              >
                ...
                <p className="mt-3 text-[13px] text-ink/70 leading-[1.55]">{d.bio}</p>
                <a
                  href="#"
        ...
        <div className="max-w-[1180px] mx-auto px-6 lg:px-10 grid grid-cols-12 gap-10 lg:gap-16 items-start">
          <div className="col-span-12 lg:col-span-5">
            ...
            <h2 className="font-display text-[36px] lg:text-[48px] leading-[1.02] tracking-[-0.02em]">
              Taste, reliability,
              <br />
              <span className="italic text-primary">and the patience to ship well.</span>
            </h2>
          </div>
          ...
          <ul className="col-span-12 lg:col-span-7 space-y-6 text-[15.5px] leading-[1.7] text-ink/85">
            {[
              ...
              <li key={x.h} className="pl-6 border-l-2 border-border-strong/60">
                <p className="font-display text-[20px] leading-[1.2] tracking-[-0.005em] text-ink">
                  {x.h}
                </p>
                <p className="mt-2 text-[14.5px] text-ink/70 leading-[1.6]">{x.p}</p>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div className="max-w-[1000px] mx-auto px-6 lg:px-10">
          <div className="mb-10 text-center">
            ...
            <h2 className="font-display text-[36px] lg:text-[52px] leading-[1.02] tracking-[-0.02em]">
              Tell us who you are.
              <br />
              <span className="italic text-primary">A real human replies.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-12 gap-10 items-end">
            <div className="col-span-12 lg:col-span-8">
              <h2 className="font-display text-[36px] sm:text-[48px] lg:text-[64px] leading-[1] tracking-[-0.02em]">
                Solo creator?
                <br />
                <span className="italic text-primary">Check the affiliate programme instead.</span>
              </h2>
            </div>
